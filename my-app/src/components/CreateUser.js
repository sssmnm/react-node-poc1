...
const CreateUser = ({onChangeForm, createUser, sendMail }) => {
    ...
    return(
        <div className="container">
            <div className="row">
                ...
                <div>
                    <input type ="text" onChange={(e) => onChangeForm(e)} name="email"></input>
                    <button type="button" onClick={(e)=> sendMail(e)}>Send Email</button>
                </div>
                </div>
            </div>
        </div>
